...
int main(int argc, char** argv)
{
	...
	std::vector<utils::Workstation*> theStations;
	std::vector<utils::CustomerOrder> theOrders;

	try {
		utils::Utilities::setDelimiter(',');
		...
		::loadFromFile<utils::CustomerOrder>(argv[3], theOrders);
		...
		for (auto& order : theOrders) {
			...
			utils::g_pending.push_back(std::move(order));
		}
		std::cout << std::endl << std::endl;
		...
		std::cout << "========================================" << std::endl;
		utils::LineManager lm(argv[4], theStations);
		lm.display(std::cout);
		std::cout << std::endl << std::endl;
	...
	std::cout << "========================================" << std::endl;
	for (const auto& o : utils::g_completed)
		o.display(std::cout);
	std::cout << std::endl << std::endl;
	...
	std::cout << "========================================" << std::endl;
	for (const auto& o : utils::g_incomplete)
		o.display(std::cout);
	std::cout << std::endl << std::endl;
	...
	std::cout << "========================================" << std::endl;
	for (const utils::Station* theItem : theStations)
